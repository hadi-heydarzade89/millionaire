                ...
                <div class="col-12 col-md-8 col-lg-6">
                    <div class="card bg-white">
                        <div class="card-body p-5">
                            ...
                            <form class="mb-3 mt-md-4" action="{{route('admin.questions.store')}}" method="post">
                                @csrf
                                <div class="mb-3">
                                    ...
                                    <input name="question" type="text" class="form-control" id="question" autofocus required>
                                </div>
                                <div class="mb-3">
                                    <label for="rate"
                                ...
                                <div class="d-grid">
                                    <button class="btn btn-outline-dark" type="submit">{{__('Create')}}</button>
                                </div>
                            </form>
                        </div>
                    </div>
